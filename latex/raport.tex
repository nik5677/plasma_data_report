...
\begin{document}
    ...
    wyszlo: Best model: ARMA(7,6) (my uzylismy 5,5 z rysunku~\ref{fig:dopasowanie_modelow})

    parametry: {\color{red}TODO (tabelka najlepiej)}
    ...
    Rysunek~\ref{fig:empiryczna_acf_po_dekompozycji_RESZTY} oraz Rysunek~\ref{fig:empiryczna_pacf_po_dekompozycji_RESZTY}
