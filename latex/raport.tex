    ...
    \maketitle
{
  ...
  \tableofcontents
    ...
    Rysunek~\ref{fig:dekompozycja} przedstawia przebieg szeregu po różnicowaniu.
    ...
    Test ADF przeprowadzony dla szeregu po dekompozycji dał statystykę −14.148 oraz wartość $p$ równą $1.7039e^{-25} \approx 0$, co jednoznacznie prowadzi do odrzucenia hipotezy o niestacjonarności.
    ...
    Otrzymana wartość $p = 2.0279e^{-32} \approx 0$ prowadzi do jednoznacznego odrzucenia hipotezy zerowej, co wskazuje na obecność efektu ARCH w resztach modelu ARMA\@.
    ...
    W pracy zastosowano klasyczne metody analizy szeregów czasowych do modelowania rzeczywistych danych pochodzących z eksperymentu fizycznego.
    Uzyskane wyniki pokazują, że modele ARMA mogą być użyteczne do opisu krótkoterminowej dynamiki badanego procesu, jednak ich zastosowanie jest ograniczone w przypadku danych charakteryzujących się heteroskedastycznością i nienormalnością rozkładu.
